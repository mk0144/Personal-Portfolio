...
setInterval(function () {
  ...
  console.log(rolesI !== roles.length && roles[roles.length - 1].length !== charPos)

  if (roles[rolesI].length > charPos) {
    charPos++;
    console.log("if");
  } else if (rolesI !== roles.length && roles[roles.length - 1].length !== charPos) {
