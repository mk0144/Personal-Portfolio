...
// \sections
// home
let roles = ["Web Developer", "Web Designer", "Director", "Marketer"];
let rolesI = 0;
let charPos = 0;
// \home
// \variables
...
setInterval(function () {
  ...
  if (roles[rolesI].length > charPos) {
    ...
    console.log(rolesI, roles[rolesI].length);
    console.log(roles[roles.length - 1].length === charPos);

     else if (roles[roles.length -1].length !== charPos) {
      rolesI++;
      charPos = 0;
